...
export const projectTiles = [
  ...
  },
  {
    ...
    iframe: 'https://www.youtube.com/embed/sQqvEzpkZys'
  },
  {
    img: './img/jam-map.png',
    title: 'The Jam Map',
    about: 'A filterable map that shows New Yorkers live music in their area. The Jam Map allows you to filter shows by date range, genre, and artist name, and also provides detailed information about each show.',
    ...
    iframe: 'https://media.giphy.com/media/uJvodVLiBUk4E/giphy.gif'
  },
  {
